...
log_params() {
  for name in enabled hits policyload_hook_hits fixups status_fixups no_status null_avd last_status_sequence last_status_policyload last_avc_policy_seqno last_avd_seqno last_repair_target last_old_seqno last_live_seqno; do
